...
public class TopThreeSalesJpanel extends javax.swing.JPanel {
    ...
    public void getTopThreeProducts(){
        ...
        for(OrderList ol:listOfOrders){
            for(Order o:ol.getOrderList()){
                if(o.getOffer().getOfferPrice().equals("Ceil")){
        ...
        for(int i=0;i<prodList.size();i++){
            map.put(prodList.get(i), priceList.get(i));
        }
        Stream<Map.Entry<Product,Double>> sorted =map.entrySet().stream().sorted(Collections.reverseOrder(Map.Entry.comparingByValue()));
        Set<Map.Entry<Product, Double>> set = map.entrySet();
        List<Map.Entry<Product, Double>> list = new ArrayList<Map.Entry<Product, Double>>(set);
    ...
    private void initComponents() {
        ...
        prodJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Revenue from Product"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 590, 120));
